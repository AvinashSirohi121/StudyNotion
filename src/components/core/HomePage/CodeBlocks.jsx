...
const CodeBlocks = ({position, heading, subHeading, ctabtn1, ctabtn2,codeblock, backgroundGradinet, codeColor,codeSpeed }) => {
  return (
    <div className={`w-[10/12] flex flex-row ${position} my-20 justify-between gap-10`}>
        {/*Section1*/}
        <div className='w-[50%] flex flex-col gap-8'>{heading}
        ...
        {/* Section 2 */}
        {/* <div className='h-[250px] bg-richblack-900/50 flex flex-row text-[10px] w-[100%] py-4 lg:w-[500px] border-[1px] border-richblack-600/50 rounded-md 
        '>
         
            <div className=' h-fit  text-center flex flex-col w-[10%] select-none text-richblack-400 font-inter font-bold'>
            ...
            <div className={`w-[90%]  flex flex-col  font-inter font-bold ${codeColor} drop-shadow-2xl shadow-white`}>
                <TypeAnimation 
         ...
         */}
{/* Section 2 */}
<div className='relative h-[250px] bg-richblack-800/50 flex flex-row text-[10px] w-[100%] py-4 lg:w-[500px] border-[1px] border-richblack-600/50 rounded-md'>
  {/* Misty Blue Shadow */}
